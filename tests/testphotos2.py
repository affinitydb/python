...
def _describeModel():
    ...
    modeling.initialize()
    modeling.describeClass("testphotos2_class_photos", {modeling.MVURI_PROP_DOCSTRING:"General category for photos, by id. Photos typically also contain a 'tags' property."})
    modeling.describeClass("testphotos2_class_tags", {modeling.MVURI_PROP_DOCSTRING:"General category for unique tags, which logically group photos together into sets, and serve as the basic unit to grant privileges to users and groups."})
    modeling.describeClass("testphotos2_class_groups", {modeling.MVURI_PROP_DOCSTRING:"Category for groups of users. Groups typically also contain a 'tags' property, representing the sets of photos to which a group was granted access."})
    modeling.describeClass("testphotos2_class_users", {modeling.MVURI_PROP_DOCSTRING:"Category for users (guests of an instance of the photo system). Users typically also contain a 'tags' property, representing the sets of photos to which an individual user was granted access (additionally to the access rights of the group it this user belongs to)."})
    modeling.describeRelation("testphotos2_tags", {modeling.MVURI_PROP_DOCSTRING:"Collection of tags.", modeling.MVURI_PROP_CATEGORY:"testphotos2_class_tags"})
    modeling.describeRelation("testphotos2_tags", {modeling.MVURI_PROP_DOCSTRING:"All photos containing the same tag form a set (album).", modeling.MVURI_PROP_CARDINALITY:modeling.MV_CARDINALITY_ONE_TO_MANY}, pClassURI="testphotos2_class_photos")
    modeling.describeRelation("testphotos2_tags", {modeling.MVURI_PROP_DOCSTRING:"All users of a group are granted permission to view the photos tagged with the tags of their group.", modeling.MVURI_PROP_CARDINALITY:modeling.MV_CARDINALITY_ONE_TO_MANY}, pClassURI="testphotos2_class_groups")
    modeling.describeRelation("testphotos2_tags", {modeling.MVURI_PROP_DOCSTRING:"A user is granted permission to view the photos tagged with its tags.", modeling.MVURI_PROP_CARDINALITY:modeling.MV_CARDINALITY_ONE_TO_MANY}, pClassURI="testphotos2_class_users")
    modeling.describeRelation("testphotos2_users", {modeling.MVURI_PROP_DOCSTRING:"Collection of users.", modeling.MVURI_PROP_CATEGORY:"testphotos2_class_users"})
    modeling.describeRelation("testphotos2_users", {modeling.MVURI_PROP_DOCSTRING:"A group is composed of users.", modeling.MVURI_PROP_CARDINALITY:modeling.MV_CARDINALITY_ONE_TO_MANY}, pClassURI="testphotos2_class_groups")
    modeling.describeAttribute("testphotos2_id", {modeling.MVURI_PROP_DOCSTRING:"The unique id of a photo is built from the sha-1 digest of the pixels (n.b. in this demo, it's just a random guid)."}, pClassURI="testphotos2_class_photos")
    modeling.describeAttribute("testphotos2_id", {modeling.MVURI_PROP_DOCSTRING:"The unique id of a user is an email id."}, pClassURI="testphotos2_class_users")
    modeling.describeAttribute("testphotos2_id", {modeling.MVURI_PROP_DOCSTRING:"The unique id of a group is the name of the group."}, pClassURI="testphotos2_class_groups")
    modeling.describeAttribute("testphotos2_tag", {modeling.MVURI_PROP_DOCSTRING:"A tag is a text string representative of a collection of photos."}, pClassURI="testphotos2_class_tags")
    modeling.describeAttribute("testphotos2_pw", {modeling.MVURI_PROP_DOCSTRING:"pw is a guest user's individual password, securing his access to the database of photos."}, pClassURI="testphotos2_class_users")
    modeling.describeAttribute("testphotos2_date", {modeling.MVURI_PROP_DOCSTRING:"The date the picture was taken. Used to order the presentation of photos in a tag, and to provide date-driven views on photos accessible to a user."}, pClassURI="testphotos2_class_photos")
    modeling.describeAttribute("testphotos2_time", {modeling.MVURI_PROP_DOCSTRING:"The time of day the picture was taken. Used to order the presentation of photos in a tag."}, pClassURI="testphotos2_class_photos")
    modeling.describeAttribute("testphotos2_path", {modeling.MVURI_PROP_DOCSTRING:"The physical file path of the photo."}, pClassURI="testphotos2_class_photos")
